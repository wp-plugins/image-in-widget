...
?>
		...
		<div class="image-in-widget-plugin">
			...
			<?php if($instance['wcp_remove_link'] == 'on') { ?>
...
?>
	...
	<p>
	    <input class="checkbox" type="checkbox" <?php checked($instance['wcp_remove_link'], 'on'); ?> id="<?php echo $this->get_field_id('wcp_remove_link'); ?>" name="<?php echo $this->get_field_name('wcp_remove_link'); ?>" /> 
